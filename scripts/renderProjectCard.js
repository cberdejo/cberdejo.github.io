export default function renderProjectCard(project, container) {
    ...
    card.innerHTML = `
        <div class="h-48 overflow-hidden cursor-pointer" onclick="openHtmlModal('${html}')">
            <img src="${image}" alt="${title}" class="w-full h-full object-cover transition duration-500 hover:scale-105">
        </div>
        <div class="p-6">
